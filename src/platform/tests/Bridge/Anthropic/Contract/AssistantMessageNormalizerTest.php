...
final class AssistantMessageNormalizerTest extends TestCase
{
    ...
    {
        $message = new AssistantMessage(new ThinkingContent('Let me think about this...', 'sig-abc'));
    ...
    {
        $message = new AssistantMessage(new ThinkingContent('Let me think about this...', 'sig-abc'), new Text('The answer is 42.'));
