...
final class ModelCatalogTest extends TestCase
{
    ...
    {
        yield 'bge-multilingual-gemma2' => ['bge-multilingual-gemma2'];
    }
    ...
    {
        yield 'llama-3.1-8b-instruct' => ['llama-3.1-8b-instruct'];
        yield 'llama-3.3-70b-instruct' => ['llama-3.3-70b-instruct'];
    }
}
