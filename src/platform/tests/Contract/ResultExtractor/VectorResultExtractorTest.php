...
final class VectorResultExtractorTest extends TestCase
{
    ...
    {
        $json = file_get_contents(\dirname(__DIR__).'/fixtures/embeddings-standard-success.json');
    ...
    {
        $json = file_get_contents(\dirname(__DIR__).'/fixtures/embeddings-specific-success.json');
