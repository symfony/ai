...
namespace Symfony\AI\Platform\Bridge\Mistral\Tests\Embeddings;

use PHPUnit\Framework\TestCase;
use Symfony\AI\Platform\Bridge\Mistral\Embeddings\ResultConverter;
...
final class ResultConverterRateLimitTest extends TestCase
{
    public function testRateLimitExceededThrowsException()
    {
        ...
        $httpResponse = $httpClient->request('POST', 'https://api.mistral.ai/v1/embeddings');
