...
final class OllamaPayload
{
    ...
    public function asGenerationPayload(): string
    {
        if (\is_array($this->payload) && !\array_key_exists('text', $this->payload)) {
            throw new InvalidArgumentException('The payload must be an array with the "text" key.');
        }
        ...
        throw new InvalidArgumentException('The payload must be either an array or a string.');
    }
