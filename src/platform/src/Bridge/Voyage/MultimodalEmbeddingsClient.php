...
/**
 * Voyage /v1/multimodalembeddings client.
 *
 * Differs from {@see EmbeddingsClient} on two fields: input is named
 * `inputs` (plural) and the encoding option is `output_encoding` rather
 * than `encoding_format`.
 *
 * @author Christopher Hertel <mail@christopher-hertel.de>
 */
final class MultimodalEmbeddingsClient implements EndpointClientInterface
{
    public const ENDPOINT = 'voyage.multimodal_embeddings';

    private const URL = 'https://api.voyageai.com/v1/multimodalembeddings';
