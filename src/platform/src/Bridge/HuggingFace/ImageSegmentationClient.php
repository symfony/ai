 ...
 */
final class ImageSegmentationClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::IMAGE_SEGMENTATION;
    ...
    {
        return new ObjectResult(ImageSegmentationResult::fromArray($raw->getData()));
    }
}
