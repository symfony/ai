 ...
 */
final class TokenClassificationClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::TOKEN_CLASSIFICATION;
    ...
    {
        return new ObjectResult(TokenClassificationResult::fromArray($raw->getData()));
    }
}
