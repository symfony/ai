 ...
 */
class AudioClassificationClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::AUDIO_CLASSIFICATION;
    ...
    {
        return new ObjectResult(ClassificationResult::fromArray($raw->getData()));
    }
}
