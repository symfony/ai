 ...
 */
final class QuestionAnsweringClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::QUESTION_ANSWERING;
    ...
    {
        return new ObjectResult(QuestionAnsweringResult::fromArray($raw->getData()));
    }
}
