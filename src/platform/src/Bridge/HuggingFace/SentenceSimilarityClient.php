 ...
 */
final class SentenceSimilarityClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::SENTENCE_SIMILARITY;
    ...
    {
        return new ObjectResult(SentenceSimilarityResult::fromArray($raw->getData()));
    }
}
