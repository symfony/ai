 ...
 */
final class FillMaskClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::FILL_MASK;
    ...
    {
        return new ObjectResult(FillMaskResult::fromArray($raw->getData()));
    }
}
