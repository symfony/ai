 ...
 */
final class ObjectDetectionClient extends AbstractTaskClient
{
    public const ENDPOINT = 'hf.'.Task::OBJECT_DETECTION;
    ...
    {
        return new ObjectResult(ObjectDetectionResult::fromArray($raw->getData()));
    }
}
