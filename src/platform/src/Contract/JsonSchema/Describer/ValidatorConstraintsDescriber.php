...
final class ValidatorConstraintsDescriber implements DescriberInterface
{
        ...
        foreach ($propertyMetadata as $metadata) {
            foreach ($metadata->getConstraints() as $constraint) {
                match (true) {
                    ...
                    $constraint instanceof Assert\Choice => $this->describeChoice($schema, $constraint),
    ...
    private function describeChoice(?array &$schema, Assert\Choice $constraint): void
    {
        ...
        if ($constraint->multiple) {
            $schema['items']['enum'] = $constraint->choices;
            ...
            if ($constraint->match) {
                ...
                $schema['not']['enum'] = $constraint->choices;
            }
        }
    }
