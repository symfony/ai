...
HELP
    ...
    /**
     * @param array<string, array{tools: array<string, array{name: string, description: string|null, handler: string, input_schema: array<string, mixed>|null}>, resources: array<string, array{uri: string, name: string|null, description: string|null, handler: string, mime_type: string|null}>, prompts: array<string, array{name: string, description: string|null, handler: string, arguments: array<mixed>|null}>, resource_templates: array<string, array{uri_template: string, name: string|null, description: string|null, handler: string}>}> $all
     *
     * @return array<string, array{tools: array<string, array{name: string, description: string|null, handler: string, input_schema: array<string, mixed>|null}>, resources: array<string, array{uri: string, name: string|null, description: string|null, handler: string, mime_type: string|null}>, prompts: array<string, array{name: string, description: string|null, handler: string, arguments: array<mixed>|null}>, resource_templates: array<string, array{uri_template: string, name: string|null, description: string|null, handler: string}>}>
     */
    ...
    /**
     * @param array<string, array{tools: array<string, array{name: string, description: string|null, handler: string, input_schema: array<string, mixed>|null}>, resources: array<string, array{uri: string, name: string|null, description: string|null, handler: string, mime_type: string|null}>, prompts: array<string, array{name: string, description: string|null, handler: string, arguments: array<mixed>|null}>, resource_templates: array<string, array{uri_template: string, name: string|null, description: string|null, handler: string}>}> $capabilities
     *
    ...
    /**
     * @param array<string, array{tools: array<string, array{name: string, description: string|null, handler: string, input_schema: array<string, mixed>|null}>, resources: array<string, array{uri: string, name: string|null, description: string|null, handler: string, mime_type: string|null}>, prompts: array<string, array{name: string, description: string|null, handler: string, arguments: array<mixed>|null}>, resource_templates: array<string, array{uri_template: string, name: string|null, description: string|null, handler: string}>}> $capabilitiesByExtension
     */
