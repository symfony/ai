...
final class MultiAgent implements AgentInterface
{
    ...
    public function call(MessageBag $messages, array $options = [], array $policies = []): ResultInterface
    {
        ...
        if (!$decision instanceof Decision) {
            ...
            return $this->orchestrator->call($messages, $options, $policies);
        }
        ...
        if (!$decision->hasAgent()) {
            ...
            return $this->fallback->call($messages, $options, $policies);
        }
        ...
        return $targetAgent->call(new MessageBag($userMessage), $options, $policies);
    }
