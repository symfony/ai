...
{
    public function testShouldCompressReturnsFalseWhenBelowSoftThreshold()
    {
        $primary = $this->createMock(CompressionStrategyInterface::class);
        $secondary = $this->createMock(CompressionStrategyInterface::class);

        $strategy = new HybridStrategy($primary, $secondary, softThreshold: 5, hardThreshold: 10);
    ...
    public function testShouldCompressReturnsTrueWhenAboveSoftThreshold()
    {
        $primary = $this->createMock(CompressionStrategyInterface::class);
        $secondary = $this->createMock(CompressionStrategyInterface::class);

        $strategy = new HybridStrategy($primary, $secondary, softThreshold: 2, hardThreshold: 10);
    ...
    public function testCompressUsesPrimaryStrategyWhenBelowHardThreshold()
    {
        $messages = new MessageBag(
            Message::ofUser('Message 1'),
            Message::ofAssistant('Response 1'),
    ...
    public function testCompressUsesSecondaryStrategyWhenAboveHardThreshold()
    {
        $messageList = [
            Message::ofUser('Message 1'),
            Message::ofAssistant('Response 1'),
        ...
        $strategy = new HybridStrategy($primary, $secondary, softThreshold: 2, hardThreshold: 5);
    ...
    public function testShouldCompressIgnoresSystemMessages()
    {
        ...
        $strategy = new HybridStrategy($primary, $secondary, softThreshold: 3, hardThreshold: 10);
