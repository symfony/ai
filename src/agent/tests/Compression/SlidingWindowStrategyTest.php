...
final class SlidingWindowStrategyTest extends TestCase
{
    ...
    {
        $strategy = new SlidingWindowStrategy(maxMessages: 5, threshold: 10);
    ...
    {
        $strategy = new SlidingWindowStrategy(maxMessages: 5, threshold: 3);
    ...
    {
        $strategy = new SlidingWindowStrategy(maxMessages: 2, threshold: 3);
