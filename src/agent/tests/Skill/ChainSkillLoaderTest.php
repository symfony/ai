...
final class ChainSkillLoaderTest extends TestCase
{
    public function testLoadSkillReturnsFirstMatch()
    {
        ...
        $loader1->expects($this->once())->method('loadSkill')->with('my-skill')->willReturn(null);

        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('loadSkill')->with('my-skill')->willReturn($skill);
    ...
    public function testLoadSkillReturnsNullWhenNoneFound()
    {
        ...
        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('loadSkill')->willReturn(null);
    ...
    public function testLoadSkillStopsAtFirstMatch()
    {
        ...
        $loader1 = $this->createMock(SkillLoaderInterface::class);
        $loader1->expects($this->once())->method('loadSkill')->willReturn($skill);
    ...
    public function testLoadSkillsAggregatesFromAllLoaders()
    {
        ...
        $loader1 = $this->createMock(SkillLoaderInterface::class);
        $loader1->expects($this->once())->method('loadSkills')->willReturn(['skill-one' => $skill1]);

        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('loadSkills')->willReturn(['skill-two' => $skill2]);
    ...
    public function testLoadSkillsFirstLoaderWinsOnConflict()
    {
        ...
        $loader1 = $this->createMock(SkillLoaderInterface::class);
        $loader1->expects($this->once())->method('loadSkills')->willReturn(['my-skill' => $skill1]);

        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('loadSkills')->willReturn(['my-skill' => $skill2]);
    ...
    public function testDiscoverMetadataAggregatesFromAllLoaders()
    {
        ...
        $loader1 = $this->createMock(SkillLoaderInterface::class);
        $loader1->expects($this->once())->method('discoverMetadata')->willReturn(['skill-one' => $meta1]);

        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('discoverMetadata')->willReturn(['skill-two' => $meta2]);
    ...
    public function testDiscoverMetadataFirstLoaderWinsOnConflict()
    {
        ...
        $loader1 = $this->createMock(SkillLoaderInterface::class);
        $loader1->expects($this->once())->method('discoverMetadata')->willReturn(['my-skill' => $meta1]);

        $loader2 = $this->createMock(SkillLoaderInterface::class);
        $loader2->expects($this->once())->method('discoverMetadata')->willReturn(['my-skill' => $meta2]);
