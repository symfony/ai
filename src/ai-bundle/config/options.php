                    ...
                    ->children()
                        ...
                        ->arrayNode('skills')
                            ...
                            ->children()
                                ...
                                ->stringNode('loader')
                                    ->defaultValue('ai.skills.filesystem_loader')
                                    ->info('A service implementing "Symfony\AI\Agent\Skill\SkillLoaderInterface", default to "ai.skills.filesystem_loader".')
                                ->end()
