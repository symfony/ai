            ...
            ->arrayNode('agent')
                ...
                ->arrayPrototype()
                    ->children()
                        ...
                        ->end()
                        ->arrayNode('speech')
                            ->info('Speech configuration for the agent (TTS/STT)')
                            ->addDefaultsIfNotSet()
                            ->treatFalseLike(['enabled' => false])
                            ->treatTrueLike(['enabled' => true])
                            ...
                            ->children()
                                ...
                                ->stringNode('platform')
                                    ->info('Platform service name to use for speech (e.g. "ai.platform.elevenlabs")')
                                    ->defaultNull()
                                ->end()
                                ->stringNode('tts_model')
                                    ->info('Model name for text-to-speech')
                                    ->defaultNull()
                                ->end()
                                ->arrayNode('tts_options')
                                    ->info('Options for text-to-speech')
                                    ->variablePrototype()->end()
                                    ->defaultValue([])
                                ->end()
                                ->stringNode('stt_model')
                                    ->info('Model name for speech-to-text')
                                    ->defaultNull()
                                ->end()
                                ->arrayNode('stt_options')
                                    ->info('Extra options for speech-to-text')
                                    ->variablePrototype()->end()
                                    ->defaultValue([])
                                ->end()
                            ->end()
