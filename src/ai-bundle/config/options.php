                    ...
                    ->children()
                        ...
                        ->arrayNode('speech')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->booleanNode('session')
                                    ->info('Wrap the SpeechAgent in a SpeechSession, so a new call() automatically cancels the previous in-flight result and flips its interruption signal. Intended for long-running contexts (WebSocket, daemon, event loop).')
                                    ->defaultFalse()
                                ->end()
                            ->end()
                            ->validate()
