...
final class AiBundleTest extends TestCase
{
    ...
    public function testAgentCanUseSkills()
    {
        ...
        $this->assertCount(4, $discoveryDefinition->getArguments());
        ...
        $this->assertSame('ai.skills.validator', (string) $discoveryDefinition->getArgument(2));
        $this->assertInstanceOf(Reference::class, $discoveryDefinition->getArgument(3));
        $this->assertSame('filesystem', (string) $discoveryDefinition->getArgument(3));
