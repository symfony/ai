...
the `#[AsOutputProcessor]` attributes::
    ...
    #[AsInputProcessor(priority: 99)] // This apply to every agents
    #[AsOutputProcessor(agent: 'my_agent_id')] // The output processor will only be registered for this specific agent
