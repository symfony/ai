 ...
 * Add support for referencing one of the application's own MCP servers in an `mcp_server` tool entry by its plain name, calling its tools in-process through `LocalServerToolset`
