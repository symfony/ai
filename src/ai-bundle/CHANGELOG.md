 ...
 * Register the Anthropic job client as `ai.platform.job_client.anthropic`, tagged and autowired by argument name, so a stored batch handle can be resolved from a worker
