...
final class HybridStoreTest extends TestCase
{
    ...
    public function testBoostFieldsApplied()
    {
        ...
        $this->assertSame(0.75, $results[0]->score);
        $this->assertArrayHasKey('_applied_boosts', $results[0]->metadata->getArrayCopy());
    ...
    public function testScoreBreakdownIncluded()
    {
        ...
        $metadata = $results[0]->metadata->getArrayCopy();
    ...
    public function testNullVectorForFtsOnlyResults()
    {
        ...
        $results = $store->query(new Vector([0.1, 0.2, 0.3]), ['q' => 'FTS']);
    ...
    public function testScoreNormalization()
    {
        ...
        $this->assertEqualsWithDelta($expectedNormalized, $results[0]->score, 0.01);
    }
