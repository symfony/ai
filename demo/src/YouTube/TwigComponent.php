...
final class TwigComponent
{
    ...
    public function __construct(
        ...
        private readonly ChatInterface $youtubeChat,
        private readonly MessageStoreInterface $youtubeMessageStore,
    ...
    public function start(#[LiveArg] string $videoId): void
    {
        ...
        try {
            ...
            $this->youtubeMessageStore->clear();
        }
    }
    ...
    {
        return $this->youtubeChat->getCurrentMessageBag()->withoutSystemMessage()->getMessages();
    }

    #[LiveAction]
    public function submit(#[LiveArg] string $message): void
    {
        $this->youtubeChat->submit(Message::ofUser($message));
    }
    ...
    private function doStart(string $videoId): void
    {
        ...
        $this->reset();
        $this->youtubeChat->initiate($messages);
    }
}
