...
$toolFactory->addTool($tool, 'skill_script_example', 'Consult the twig-component skill for Symfony UX TwigComponent knowledge. Optionally pass a reference path like "api.md" for detailed docs.');
