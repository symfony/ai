...
$executors = [
    ...
    'review' => new FiberExecutor(static function (WorkflowState $state, string $place) use ($reviewerAgent): WorkflowState {
    ...
    'approved' => new FiberExecutor(static function (WorkflowState $state, string $place): WorkflowState {
        return $state->set('status', 'published');
    }),

    'rejected' => new FiberExecutor(static function (WorkflowState $state, string $place): WorkflowState {
