...
$executors = [
    ...
    'done' => new CallableExecutor(static fn (WorkflowStateInterface $state, string $place): WorkflowStateInterface => $state->set('completed_at', (new MonotonicClock())->now()->format('Y-m-d H:i:s'))),
];
