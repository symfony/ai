...
$modelCatalog = new ModelApiCatalog(http_client(), euRouting: true, apiKey: env('OPENROUTER_KEY'));

$platform = PlatformFactory::create(env('OPENROUTER_KEY'), http_client(), $modelCatalog, euRouting: true);
