...
$platform = Factory::createPlatform(env('FIREWORKS_API_KEY'), http_client(), eventDispatcher: $dispatcher);

$clock = new Clock(new SymfonyClock());
$toolbox = new Toolbox([$clock], logger: logger());
$toolProcessor = new AgentProcessor($toolbox);
$agent = new Agent($platform, 'accounts/fireworks/models/kimi-k2p6', [$toolProcessor], [$toolProcessor]);

$messages = new MessageBag(
    // Fireworks requires mentioning JSON in the prompt when using structured output.
